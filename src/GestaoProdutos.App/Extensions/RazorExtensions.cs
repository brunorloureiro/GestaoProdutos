...
namespace GestaoProdutos.App.Extensions
{
    public static class RazorExtensions
    {
        public static string FormataCNPJ(this RazorPage page, int tipoPessoa, string CNPJ)
        {
            return tipoPessoa == 1 ? Convert.ToUInt64(CNPJ).ToString(@"000\.000\.000\-00") : Convert.ToUInt64(CNPJ).ToString(@"00\.000\.000\/0000\-00");
        }
